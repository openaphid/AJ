...
ASSERT_CLASS_FITS_IN_CELL(AJObject);
...
void AJObject::markChildren(MarkStack& markStack)
{
#ifndef NDEBUG
...
UString AJObject::className() const
{
...
bool AJObject::getOwnPropertySlot(ExecState* exec, unsigned propertyName, PropertySlot& slot)
{
...
// ECMA 8.6.2.2
void AJObject::put(ExecState* exec, const Identifier& propertyName, AJValue value, PutPropertySlot& slot)
{
    ASSERT(value);
    ...
    if (propertyName == exec->propertyNames().underscoreProto) {
        ...
        AJValue nextPrototypeValue = value;
        while (nextPrototypeValue && nextPrototypeValue.isObject()) {
            AJObject* nextPrototype = asObject(nextPrototypeValue)->unwrappedObject();
    ...
    AJValue prototype;
    for (AJObject* obj = this; !obj->structure()->hasGetterSetterProperties(); obj = asObject(prototype)) {
    ...
    if ((m_structure->get(propertyName, attributes, specificValue) != ATF::notFound) && attributes & ReadOnly)
        return;

    for (AJObject* obj = this; ; obj = asObject(prototype)) {
        if (AJValue gs = obj->getDirect(propertyName)) {
            if (gs.isGetterSetter()) {
                AJObject* setterFunc = asGetterSetter(gs)->setter();        
                if (!setterFunc) {
...
void AJObject::put(ExecState* exec, unsigned propertyName, AJValue value)
{
    PutPropertySlot slot;
    put(exec, Identifier::from(exec, propertyName), value, slot);
}

void AJObject::putWithAttributes(ExecState* exec, const Identifier& propertyName, AJValue value, unsigned attributes, bool checkReadOnly, PutPropertySlot& slot)
{
    putDirectInternal(exec->globalData(), propertyName, value, attributes, checkReadOnly, slot);
}

void AJObject::putWithAttributes(ExecState* exec, const Identifier& propertyName, AJValue value, unsigned attributes)
{
    putDirectInternal(exec->globalData(), propertyName, value, attributes);
}

void AJObject::putWithAttributes(ExecState* exec, unsigned propertyName, AJValue value, unsigned attributes)
{
    putWithAttributes(exec, Identifier::from(exec, propertyName), value, attributes);
}

bool AJObject::hasProperty(ExecState* exec, const Identifier& propertyName) const
{
    PropertySlot slot;
    return const_cast<AJObject*>(this)->getPropertySlot(exec, propertyName, slot);
}

bool AJObject::hasProperty(ExecState* exec, unsigned propertyName) const
{
    PropertySlot slot;
    return const_cast<AJObject*>(this)->getPropertySlot(exec, propertyName, slot);
}
...
// ECMA 8.6.2.5
bool AJObject::deleteProperty(ExecState* exec, const Identifier& propertyName)
{
    unsigned attributes;
    AJCell* specificValue;
    if (m_structure->get(propertyName, attributes, specificValue) != ATF::notFound) {
...
bool AJObject::hasOwnProperty(ExecState* exec, const Identifier& propertyName) const
{
    PropertySlot slot;
    return const_cast<AJObject*>(this)->getOwnPropertySlot(exec, propertyName, slot);
}

bool AJObject::deleteProperty(ExecState* exec, unsigned propertyName)
{
    return deleteProperty(exec, Identifier::from(exec, propertyName));
}

static ALWAYS_INLINE AJValue callDefaultValueFunction(ExecState* exec, const AJObject* object, const Identifier& propertyName)
{
    AJValue function = object->get(exec, propertyName);
    CallData callData;
    ...
    AJValue result = call(exec, function, callType, callData, const_cast<AJObject*>(object), exec->emptyList());
...
bool AJObject::getPrimitiveNumber(ExecState* exec, double& number, AJValue& result)
{
...
// ECMA 8.6.2.6
AJValue AJObject::defaultValue(ExecState* exec, PreferredPrimitiveType hint) const
{
    // Must call toString first for Date objects.
    if ((hint == PreferString) || (hint != PreferNumber && prototype() == exec->lexicalGlobalObject()->datePrototype())) {
        AJValue value = callDefaultValueFunction(exec, this, exec->propertyNames().toString);
        if (value)
            return value;
        ...
        AJValue value = callDefaultValueFunction(exec, this, exec->propertyNames().valueOf);
        if (value)
            return value;
...
const HashEntry* AJObject::findPropertyHashEntry(ExecState* exec, const Identifier& propertyName) const
{
...
void AJObject::defineGetter(ExecState* exec, const Identifier& propertyName, AJObject* getterFunction, unsigned attributes)
{
    AJValue object = getDirect(propertyName);
...
void AJObject::defineSetter(ExecState* exec, const Identifier& propertyName, AJObject* setterFunction, unsigned attributes)
{
    AJValue object = getDirect(propertyName);
    if (object && object.isGetterSetter()) {
        ASSERT(m_structure->hasGetterSetterProperties());
...
AJValue AJObject::lookupGetter(ExecState*, const Identifier& propertyName)
{
    AJObject* object = this;
    while (true) {
        if (AJValue value = object->getDirect(propertyName)) {
            if (!value.isGetterSetter())
                return jsUndefined();
            AJObject* functionObject = asGetterSetter(value)->getter();
            if (!functionObject)
                return jsUndefined();
...
AJValue AJObject::lookupSetter(ExecState*, const Identifier& propertyName)
{
    AJObject* object = this;
    while (true) {
        if (AJValue value = object->getDirect(propertyName)) {
            if (!value.isGetterSetter())
                return jsUndefined();
            AJObject* functionObject = asGetterSetter(value)->setter();
            if (!functionObject)
                return jsUndefined();
            return functionObject;
        }
...
bool AJObject::hasInstance(ExecState* exec, AJValue value, AJValue proto)
{
    if (!value.isObject())
        return false;
    ...
    AJObject* object = asObject(value);
...
bool AJObject::propertyIsEnumerable(ExecState* exec, const Identifier& propertyName) const
{
    PropertyDescriptor descriptor;
    if (!const_cast<AJObject*>(this)->getOwnPropertyDescriptor(exec, propertyName, descriptor))
        return false;
    return descriptor.enumerable();
}

bool AJObject::getPropertySpecificValue(ExecState*, const Identifier& propertyName, AJCell*& specificValue) const
{
    unsigned attributes;
    if (m_structure->get(propertyName, attributes, specificValue) != ATF::notFound)
        return true;
...
void AJObject::getPropertyNames(ExecState* exec, PropertyNameArray& propertyNames, EnumerationMode mode)
{
    ...
    AJObject* prototype = asObject(this->prototype());
    while(1) {
        ...
        AJValue nextProto = prototype->prototype();
        if (nextProto.isNull())
            break;
...
void AJObject::getOwnPropertyNames(ExecState* exec, PropertyNameArray& propertyNames, EnumerationMode mode)
{
    m_structure->getPropertyNames(propertyNames, mode);
    getClassPropertyNames(exec, classInfo(), propertyNames, mode);
}

bool AJObject::toBoolean(ExecState*) const
{
    return true;
}

double AJObject::toNumber(ExecState* exec) const
{
    AJValue primitive = toPrimitive(exec, PreferNumber);
    if (exec->hadException()) // should be picked up soon in Nodes.cpp
        return 0.0;
    return primitive.toNumber(exec);
}

UString AJObject::toString(ExecState* exec) const
{
    AJValue primitive = toPrimitive(exec, PreferString);
    if (exec->hadException())
        return "";
    return primitive.toString(exec);
}

AJObject* AJObject::toObject(ExecState*) const
{
    return const_cast<AJObject*>(this);
}

AJObject* AJObject::toThisObject(ExecState*) const
{
    return const_cast<AJObject*>(this);
}

AJObject* AJObject::unwrappedObject()
{
    return this;
}

void AJObject::removeDirect(const Identifier& propertyName)
{
    size_t offset;
...
void AJObject::putDirectFunction(ExecState* exec, InternalFunction* function, unsigned attr)
{
    putDirectFunction(Identifier(exec, function->name(exec)), function, attr);
}

void AJObject::putDirectFunctionWithoutTransition(ExecState* exec, InternalFunction* function, unsigned attr)
{
    putDirectFunctionWithoutTransition(Identifier(exec, function->name(exec)), function, attr);
}

NEVER_INLINE void AJObject::fillGetterPropertySlot(PropertySlot& slot, AJValue* location)
{
    if (AJObject* getterFunction = asGetterSetter(*location)->getter()) {
...
Structure* AJObject::createInheritorID()
{
    m_inheritorID = AJObject::createStructure(this);
    return m_inheritorID.get();
}

void AJObject::allocatePropertyStorage(size_t oldSize, size_t newSize)
{
    allocatePropertyStorageInline(oldSize, newSize);
}

bool AJObject::getOwnPropertyDescriptor(ExecState*, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool AJObject::getPropertyDescriptor(ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    AJObject* object = this;
    while (true) {
...
static bool putDescriptor(ExecState* exec, AJObject* target, const Identifier& propertyName, PropertyDescriptor& descriptor, unsigned attributes, AJValue oldValue)
{
...
bool AJObject::defineOwnProperty(ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor, bool throwException)
{
    ...
    if (descriptor.isDataDescriptor()) {
        if (!current.configurable()) {
            ...
            if (!current.writable()) {
                if (descriptor.value() || !AJValue::strictEqual(exec, current.value(), descriptor.value())) {
                    if (throwException)
    ...
    if (!current.configurable()) {
        if (descriptor.setterPresent() && !(current.setter() && AJValue::strictEqual(exec, current.setter(), descriptor.setter()))) {
            if (throwException)
                throwError(exec, TypeError, "Attempting to change the setter of an unconfigurable property.");
            return false;
        }
        if (descriptor.getterPresent() && !(current.getter() && AJValue::strictEqual(exec, current.getter(), descriptor.getter()))) {
            if (throwException)
                throwError(exec, TypeError, "Attempting to change the getter of an unconfigurable property.");
            return false;
        }
    }
    AJValue accessor = getDirect(propertyName);
    if (!accessor)
        return false;

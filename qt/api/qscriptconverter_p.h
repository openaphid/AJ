...
class QScriptConverter {
public:
    static quint32 toArrayIndex(const AJStringRef jsstring)
    {
    ...
    static QString toString(const AJStringRef str)
    {
        return QString(reinterpret_cast<const QChar*>(AJStringGetCharactersPtr(str)), AJStringGetLength(str));
    }
    static AJStringRef toString(const QString& str)
    {
        return AJStringCreateWithUTF8CString(str.toUtf8().constData());
    }
    static AJStringRef toString(const char* str)
    {
        return AJStringCreateWithUTF8CString(str);
    }

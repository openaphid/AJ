...
static AJValue JSC_HOST_CALL stringProtoFuncToString(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncCharAt(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncCharCodeAt(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncConcat(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncIndexOf(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncLastIndexOf(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncMatch(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncReplace(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSearch(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSlice(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSplit(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSubstr(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSubstring(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncToLowerCase(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncToUpperCase(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncLocaleCompare(ExecState*, AJObject*, AJValue, const ArgList&);

static AJValue JSC_HOST_CALL stringProtoFuncBig(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSmall(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncBlink(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncBold(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncFixed(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncItalics(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncStrike(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSub(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncSup(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncFontcolor(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncFontsize(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncAnchor(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncLink(ExecState*, AJObject*, AJValue, const ArgList&);

static AJValue JSC_HOST_CALL stringProtoFuncTrim(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncTrimLeft(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL stringProtoFuncTrimRight(ExecState*, AJObject*, AJValue, const ArgList&);
...
AJValue jsSpliceSubstringsWithSeparators(ExecState* exec, AJString* sourceVal, const UString& source, const StringRange* substringRanges, int rangeCount, const UString* separators, int separatorCount);
AJValue jsSpliceSubstringsWithSeparators(ExecState* exec, AJString* sourceVal, const UString& source, const StringRange* substringRanges, int rangeCount, const UString* separators, int separatorCount)
{
...
AJValue JSC_HOST_CALL stringProtoFuncReplace(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    AJString* sourceVal = thisValue.toThisAJString(exec);
    AJValue pattern = args.at(0);
    AJValue replacement = args.at(1);
    ...
    if (pattern.inherits(&RegExpObject::info)) {
        ...
        if (global && callType == CallTypeJS) {
            ...
            AJFunction* func = asFunction(replacement);
...
AJValue JSC_HOST_CALL stringProtoFuncToString(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
...
AJValue JSC_HOST_CALL stringProtoFuncCharAt(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    unsigned len = s.size();
    AJValue a0 = args.at(0);
    if (a0.isUInt32()) {
...
AJValue JSC_HOST_CALL stringProtoFuncCharCodeAt(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    unsigned len = s.size();
    AJValue a0 = args.at(0);
...
AJValue JSC_HOST_CALL stringProtoFuncConcat(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
...
AJValue JSC_HOST_CALL stringProtoFuncIndexOf(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    int len = s.size();

    AJValue a0 = args.at(0);
    AJValue a1 = args.at(1);
...
AJValue JSC_HOST_CALL stringProtoFuncLastIndexOf(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    int len = s.size();
...
AJValue JSC_HOST_CALL stringProtoFuncMatch(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
...
AJValue JSC_HOST_CALL stringProtoFuncSearch(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
...
AJValue JSC_HOST_CALL stringProtoFuncSlice(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    int len = s.size();
...
AJValue JSC_HOST_CALL stringProtoFuncSplit(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    ...
    AJArray* result = constructEmptyArray(exec);
    unsigned i = 0;
    unsigned p0 = 0;
...
AJValue JSC_HOST_CALL stringProtoFuncSubstr(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{    
    int len;
    AJString* jsString = 0;
    UString uString;
    if (thisValue.isString()) {
        jsString = static_cast<AJString*>(thisValue.asCell());
        len = jsString->length();
    } else {
...
AJValue JSC_HOST_CALL stringProtoFuncSubstring(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    int len;
    AJString* jsString = 0;
    UString uString;
...
AJValue JSC_HOST_CALL stringProtoFuncToLowerCase(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    AJString* sVal = thisValue.toThisAJString(exec);
...
AJValue JSC_HOST_CALL stringProtoFuncToUpperCase(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    AJString* sVal = thisValue.toThisAJString(exec);
    const UString& s = sVal->value(exec);
...
AJValue JSC_HOST_CALL stringProtoFuncLocaleCompare(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    if (args.size() < 1)
...
AJValue JSC_HOST_CALL stringProtoFuncBig(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<big>", s, "</big>");
}

AJValue JSC_HOST_CALL stringProtoFuncSmall(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<small>", s, "</small>");
}

AJValue JSC_HOST_CALL stringProtoFuncBlink(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<blink>", s, "</blink>");
}

AJValue JSC_HOST_CALL stringProtoFuncBold(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<b>", s, "</b>");
}

AJValue JSC_HOST_CALL stringProtoFuncFixed(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<tt>", s, "</tt>");
}

AJValue JSC_HOST_CALL stringProtoFuncItalics(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<i>", s, "</i>");
}

AJValue JSC_HOST_CALL stringProtoFuncStrike(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<strike>", s, "</strike>");
}

AJValue JSC_HOST_CALL stringProtoFuncSub(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<sub>", s, "</sub>");
}

AJValue JSC_HOST_CALL stringProtoFuncSup(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    UString s = thisValue.toThisString(exec);
    return jsMakeNontrivialString(exec, "<sup>", s, "</sup>");
}

AJValue JSC_HOST_CALL stringProtoFuncFontcolor(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    AJValue a0 = args.at(0);
...
AJValue JSC_HOST_CALL stringProtoFuncFontsize(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    AJValue a0 = args.at(0);
...
AJValue JSC_HOST_CALL stringProtoFuncAnchor(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    AJValue a0 = args.at(0);
...
AJValue JSC_HOST_CALL stringProtoFuncLink(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    UString s = thisValue.toThisString(exec);
    AJValue a0 = args.at(0);
...
static inline AJValue trimString(ExecState* exec, AJValue thisValue, int trimKind)
{
...
AJValue JSC_HOST_CALL stringProtoFuncTrim(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    return trimString(exec, thisValue, TrimLeft | TrimRight);
}

AJValue JSC_HOST_CALL stringProtoFuncTrimLeft(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    return trimString(exec, thisValue, TrimLeft);
}

AJValue JSC_HOST_CALL stringProtoFuncTrimRight(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{

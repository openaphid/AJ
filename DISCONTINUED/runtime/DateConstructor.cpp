...
static AJValue JSC_HOST_CALL dateParse(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL dateNow(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL dateUTC(ExecState*, AJObject*, AJValue, const ArgList&);
...
static AJObject* constructWithDateConstructor(ExecState* exec, AJObject*, const ArgList& args)
{
...
static AJValue JSC_HOST_CALL dateParse(ExecState* exec, AJObject*, AJValue, const ArgList& args)
{
    return jsNumber(exec, parseDate(exec, args.at(0).toString(exec)));
}

static AJValue JSC_HOST_CALL dateNow(ExecState* exec, AJObject*, AJValue, const ArgList&)
{

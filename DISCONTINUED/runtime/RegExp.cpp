...
inline RegExp::RegExp(AJGlobalData* globalData, const UString& pattern)
    : m_pattern(pattern)
    , m_flagBits(0)
...
inline RegExp::RegExp(AJGlobalData* globalData, const UString& pattern, const UString& flags)
    : m_pattern(pattern)
    , m_flagBits(0)
    , m_constructionError(0)
    , m_numSubpatterns(0)
...
PassRefPtr<RegExp> RegExp::create(AJGlobalData* globalData, const UString& pattern)
{
    return adoptRef(new RegExp(globalData, pattern));
}

PassRefPtr<RegExp> RegExp::create(AJGlobalData* globalData, const UString& pattern, const UString& flags)
{
...
void RegExp::compile(AJGlobalData* globalData)
{
#if ENABLE(YARR_JIT)
...
void RegExp::compile(AJGlobalData*)
{
    m_regExp = 0;

...
static AJValue JSC_HOST_CALL numberProtoFuncToString(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL numberProtoFuncToLocaleString(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL numberProtoFuncValueOf(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL numberProtoFuncToFixed(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL numberProtoFuncToExponential(ExecState*, AJObject*, AJValue, const ArgList&);
static AJValue JSC_HOST_CALL numberProtoFuncToPrecision(ExecState*, AJObject*, AJValue, const ArgList&);
...
static UString integerPartNoExp(double d)
{
    ...
    int sign;
    char result[80];
    ATF::dtoa(result, d, 0, &decimalPoint, &sign, NULL);
...
AJValue JSC_HOST_CALL numberProtoFuncToString(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    AJValue v = thisValue.getJSNumber();
    if (!v)
        return throwError(exec, TypeError);

    AJValue radixValue = args.at(0);
    int radix;
...
AJValue JSC_HOST_CALL numberProtoFuncToLocaleString(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
...
AJValue JSC_HOST_CALL numberProtoFuncValueOf(ExecState* exec, AJObject*, AJValue thisValue, const ArgList&)
{
    AJValue v = thisValue.getJSNumber();
    if (!v)
        return throwError(exec, TypeError);
...
AJValue JSC_HOST_CALL numberProtoFuncToFixed(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    AJValue v = thisValue.getJSNumber();
    if (!v)
        return throwError(exec, TypeError);

    AJValue fractionDigits = args.at(0);
...
AJValue JSC_HOST_CALL numberProtoFuncToExponential(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    AJValue v = thisValue.getJSNumber();
    if (!v)
        return throwError(exec, TypeError);
    ...
    AJValue fractionalDigitsValue = args.at(0);
    ...
    int sign;
    char result[80];
    ATF::dtoa(result, x, 0, &decimalPoint, &sign, NULL);
...
AJValue JSC_HOST_CALL numberProtoFuncToPrecision(ExecState* exec, AJObject*, AJValue thisValue, const ArgList& args)
{
    AJValue v = thisValue.getJSNumber();
    if (!v)
        return throwError(exec, TypeError);
